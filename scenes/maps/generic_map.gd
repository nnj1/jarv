...
func _ready() -> void:
	...
	for origin_position in GlobalVars.generate_random_points($rv_spawn_point.global_position, 1000, 50, 50):
		...
		main_game_node.global_teleport(scene_instance, origin_position)
