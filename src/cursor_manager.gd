...
var drag_cursor = preload("res://assets/kenney_cursor-pack/PNG/Outline/Default/resize_a_cross.png")
...
func _ready():
	...
	Input.set_custom_mouse_cursor(drag_cursor, Input.CURSOR_DRAG, Vector2(10, 0))
